...
You can access the charts and table showing the town X outputs of analysis of the data by clicking their title in the navigation bar.

``````````````````````````````````````````````````````````````````````````
``````````````````````````````````````````````````````````````````````````
# 1.1 Population Pyramid
## column {data-width=350}
### Chart-1.1 Population Pyramid
...
```
# 1.1 Age and Sex by District
## Column {data-width=350, .tabset}
### Table - 1.1 Age and Sex by District
...
# 1.4 Current Sickness (symptoms)
## column {data-width=350}
### Chart - 1.4 Current Sickness (symptoms)
...
# 1.5 Sought Health Facility
## column {data-width=350}
### Chart - 1.5 Sought Health Facility
...
# 1.6 Main Percieved community health problem
## column {data-width=350}
...
# 2. Districts Dashboard
**Districts**

You can access the charts showing the districts outputs of analysis of the data by clicking their title in the navigation bar.
...
# 2.5 Main Percieved community health problem
## column {data-width=350}
